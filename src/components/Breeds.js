...
const Breeds = () => {
    ...
    const [selectedBreed, seSselectedBreed] = useState('https://cdn2.thedogapi.com/images/HJHmix5NQ_1280.jpg')
    ...
    <Select
        ...
        <div style={{fontSize: 38,fontFamily: "sans-serif", fontWeight: "bold"}}>{selectedBreed.name}</div>
